        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:block">
            <Button 
              ...
              onClick={() => window.open('https://api.whatsapp.com/send?phone=554898864120&text=Olá! Gostaria de agendar uma avaliação personalizada do Protocolo SEPB-Digital®', '_blank')}
            >
              Agendar Avaliação
            </Button>
          </div>
